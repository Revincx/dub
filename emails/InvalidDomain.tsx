          ...
          <MjmlSection cssClass="smooth">
            <MjmlColumn>
              ...
              <MjmlText cssClass="paragraph">
                ...
                <a href={`https://${process.env.DUB_APP_DOMAIN}/${projectSlug}`} target="_blank">
                  {projectSlug}↗
                </a>{" "}
              ...
              <ButtonPrimary
                link={`https://${process.env.DUB_APP_DOMAIN}/${projectSlug}/settings`}
                uiText="Configure my domain"
              />
              <MjmlText cssClass="paragraph">
                If you do not want to keep this project on Dub, you can{" "}
                <a
                  href={`https://${process.env.DUB_APP_DOMAIN}/${projectSlug}/settings`}
                  target="_blank"
                >
                  delete it
                </a>{" "}
